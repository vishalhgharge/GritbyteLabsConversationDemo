...
exports.SquaredBarsSpectrumVisualizer = void 0;
...
var DEFAULT_BAR_WIDTH = 18;
var SquaredBarsSpectrumVisualizer = function (_a) {
    var numBars = _a.numBars, colors = _a.colors, lowFrequency = _a.lowFrequency, highFrequency = _a.highFrequency;
    ...
    (0, fiber_1.useFrame)(function () {
        if (analyser && audioContext) {
            ...
            for (var i = 0; i < nBars; i++) {
                ...
                bars_1.push((0, jsx_runtime_1.jsx)(SquaredBar_1.SquaredBar, { width: DEFAULT_BAR_WIDTH, height: height, position: [x, y], colors: colors }, i));
            }
            setBars(bars_1);
        }
    });
...
exports.SquaredBarsSpectrumVisualizer = SquaredBarsSpectrumVisualizer;
